...
.method public static parse(Lorg/apache/http/HttpEntity;)Ljava/util/List;
    ...
    invoke-virtual {v0, v8, v9, v4}, Lorg/apache/http/util/CharArrayBuffer;->append([CII)V
    :try_end_0
    ...
    .line 134
    .end local v0    # "buf":Lorg/apache/http/util/CharArrayBuffer;
    .end local v4    # "l":I
    ...
    .line 134
    .restart local v0    # "buf":Lorg/apache/http/util/CharArrayBuffer;
    ...
    invoke-static {v0, v1, v9}, Lorg/apache/http/client/utils/URLEncodedUtils;->parse(Lorg/apache/http/util/CharArrayBuffer;Ljava/nio/charset/Charset;[C)Ljava/util/List;
...
.method public static varargs parse(Lorg/apache/http/util/CharArrayBuffer;Ljava/nio/charset/Charset;[C)Ljava/util/List;
    ...
    invoke-static {p0, v11}, Lorg/apache/http/util/Args;->notNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    .line 280
    sget-object v9, Lorg/apache/http/message/TokenParser;->INSTANCE:Lorg/apache/http/message/TokenParser;

    .line 281
    .local v9, "tokenParser":Lorg/apache/http/message/TokenParser;
    new-instance v3, Ljava/util/BitSet;

    invoke-direct {v3}, Ljava/util/BitSet;-><init>()V

    .line 282
    .local v3, "delimSet":Ljava/util/BitSet;
    ...
    invoke-direct {v1, v11, v12}, Lorg/apache/http/message/ParserCursor;-><init>(II)V
    ...
    .line 287
    .local v6, "list":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/NameValuePair;>;"
    :cond_1
    :goto_1
    ...
    .line 289
    invoke-virtual {v9, p0, v1, v3}, Lorg/apache/http/message/TokenParser;->parseToken(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/message/ParserCursor;Ljava/util/BitSet;)Ljava/lang/String;
    ...
    .line 292
    invoke-virtual {v1}, Lorg/apache/http/message/ParserCursor;->getPos()I

    move-result v11

    invoke-virtual {p0, v11}, Lorg/apache/http/util/CharArrayBuffer;->charAt(I)C
    ...
    invoke-virtual {v1, v11}, Lorg/apache/http/message/ParserCursor;->updatePos(I)V
    ...
    .line 296
    invoke-virtual {v9, p0, v1, v3}, Lorg/apache/http/message/TokenParser;->parseValue(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/message/ParserCursor;Ljava/util/BitSet;)Ljava/lang/String;
    ...
    invoke-static {v10, p1}, Lorg/apache/http/client/utils/URLEncodedUtils;->decodeFormFields(Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;
