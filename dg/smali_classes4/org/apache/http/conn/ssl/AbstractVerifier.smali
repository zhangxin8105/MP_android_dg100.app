...
.method public static getCNs(Ljava/security/cert/X509Certificate;)[Ljava/lang/String;
    ...
    .line 223
    .local v2, "subjectPrincipal":Ljava/lang/String;
    :try_start_0
...
.method public static getDNSSubjectAlts(Ljava/security/cert/X509Certificate;)[Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lorg/apache/http/conn/ssl/DefaultHostnameVerifier;->extractSubjectAlts(Ljava/security/cert/X509Certificate;I)Ljava/util/List;
...
.method public final verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v4, v7}, Ljavax/security/auth/x500/X500Principal;->getName(Ljava/lang/String;)Ljava/lang/String;
...
.method public final verify(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;Z)V
    ...
    .line 153
    .local v6, "subjectAltList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_0
    invoke-static {p1}, Lorg/apache/http/conn/util/InetAddressUtils;->isIPv6Address(Ljava/lang/String;)Z
    ...
    .line 160
    .local v2, "normalizedAltSubject":Ljava/lang/String;
    :goto_2
    ...
    .end local v2    # "normalizedAltSubject":Ljava/lang/String;
    .end local v5    # "subjectAlt":Ljava/lang/String;
    :cond_2
    return-void

    .end local v0    # "cn":Ljava/lang/String;
    .end local v4    # "normalizedHost":Ljava/lang/String;
    .end local v6    # "subjectAltList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_3
    move-object v0, v6
    ...
    .restart local v0    # "cn":Ljava/lang/String;
    .restart local v6    # "subjectAltList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_4
    move-object v4, p1
    ...
    .restart local v4    # "normalizedHost":Ljava/lang/String;
    .restart local v5    # "subjectAlt":Ljava/lang/String;
    :cond_5
    move-object v2, v5
    ...
    .line 169
    .local v3, "normalizedCN":Ljava/lang/String;
    :goto_3
    ...
    .end local v3    # "normalizedCN":Ljava/lang/String;
    :cond_8
    move-object v3, v0
...
.method public final verify(Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
    ...
    .line 125
    .local v1, "ex":Ljavax/net/ssl/SSLException;
    iget-object v4, p0, Lorg/apache/http/conn/ssl/AbstractVerifier;->log:Lorg/apache/commons/logging/Log;
