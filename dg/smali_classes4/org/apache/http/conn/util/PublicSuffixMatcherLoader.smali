...
.method public static getDefault()Lorg/apache/http/conn/util/PublicSuffixMatcher;
    ...
    .prologue
    .line 80
    sget-object v3, Lorg/apache/http/conn/util/PublicSuffixMatcherLoader;->DEFAULT_INSTANCE:Lorg/apache/http/conn/util/PublicSuffixMatcher;
    ...
    .line 87
    :try_start_1
    invoke-static {v2}, Lorg/apache/http/conn/util/PublicSuffixMatcherLoader;->load(Ljava/net/URL;)Lorg/apache/http/conn/util/PublicSuffixMatcher;

    move-result-object v3

    sput-object v3, Lorg/apache/http/conn/util/PublicSuffixMatcherLoader;->DEFAULT_INSTANCE:Lorg/apache/http/conn/util/PublicSuffixMatcher;
    :try_end_1
    ...
    :cond_2
    :try_start_4
    new-instance v3, Lorg/apache/http/conn/util/PublicSuffixMatcher;
    ...
    invoke-direct {v3, v5, v6}, Lorg/apache/http/conn/util/PublicSuffixMatcher;-><init>(Ljava/util/Collection;Ljava/util/Collection;)V
...
.method private static load(Ljava/io/InputStream;)Lorg/apache/http/conn/util/PublicSuffixMatcher;
    ...
    invoke-virtual {v1, v2}, Lorg/apache/http/conn/util/PublicSuffixListParser;->parse(Ljava/io/Reader;)Lorg/apache/http/conn/util/PublicSuffixList;

    move-result-object v0

    .line 54
    .local v0, "list":Lorg/apache/http/conn/util/PublicSuffixList;
