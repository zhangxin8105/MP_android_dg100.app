...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/f$1;->cw:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Landroid/arch/lifecycle/f$1;->cw:[I

    sget-object v2, Landroid/arch/lifecycle/c$b;->cj:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_1
    sget-object v2, Landroid/arch/lifecycle/f$1;->cw:[I

    sget-object v3, Landroid/arch/lifecycle/c$b;->ck:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_2
    sget-object v3, Landroid/arch/lifecycle/f$1;->cw:[I

    sget-object v4, Landroid/arch/lifecycle/c$b;->cl:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_3
    sget-object v4, Landroid/arch/lifecycle/f$1;->cw:[I

    sget-object v5, Landroid/arch/lifecycle/c$b;->cm:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_4
    sget-object v5, Landroid/arch/lifecycle/f$1;->cw:[I

    sget-object v6, Landroid/arch/lifecycle/c$b;->ci:Landroid/arch/lifecycle/c$b;
    ...
    sput-object v5, Landroid/arch/lifecycle/f$1;->ch:[I

    :try_start_5
    sget-object v5, Landroid/arch/lifecycle/f$1;->ch:[I
