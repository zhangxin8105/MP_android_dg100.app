...
# static fields
.field static bX:Landroid/arch/lifecycle/a;
...
.field private final bZ:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Class;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/a;->bX:Landroid/arch/lifecycle/a;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/a;->bY:Ljava/util/Map;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/a;->bZ:Ljava/util/Map;
...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
    ...
    .line 107
    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/a;->d(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;
    ...
    .line 109
    iget-object v0, v0, Landroid/arch/lifecycle/a$a;->cb:Ljava/util/Map;
    ...
    .line 115
    invoke-virtual {p0, v5}, Landroid/arch/lifecycle/a;->d(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;

    move-result-object v5

    iget-object v5, v5, Landroid/arch/lifecycle/a$a;->cb:Ljava/util/Map;
    ...
    .line 138
    :goto_4
    invoke-interface {v6}, Landroid/arch/lifecycle/l;->ag()Landroid/arch/lifecycle/c$a;
    ...
    .line 158
    iget-object v0, p0, Landroid/arch/lifecycle/a;->bY:Ljava/util/Map;

    invoke-interface {v0, p1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 159
    iget-object v0, p0, Landroid/arch/lifecycle/a;->bZ:Ljava/util/Map;
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/c$a;Ljava/lang/Class;)V
    ...
    .line 92
    :cond_0
    iget-object p1, p2, Landroid/arch/lifecycle/a$b;->ce:Ljava/lang/reflect/Method;
...
.method d(Ljava/lang/Class;)Landroid/arch/lifecycle/a$a;
    .locals 1
