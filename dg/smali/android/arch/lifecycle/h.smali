...
# static fields
.field private static cy:Ljava/util/Map;
...
.field private static cz:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Class;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/h;->cy:Ljava/util/Map;
    ...
    sput-object v0, Landroid/arch/lifecycle/h;->cz:Ljava/util/Map;
...
.method private static e(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    .line 95
    :goto_1
    invoke-static {v1}, Landroid/arch/lifecycle/h;->al(Ljava/lang/String;)Ljava/lang/String;
...
.method private static f(Ljava/lang/Class;)I
    ...
    .line 116
    sget-object v0, Landroid/arch/lifecycle/h;->cy:Ljava/util/Map;
    ...
    .line 120
    sget-object v1, Landroid/arch/lifecycle/h;->cy:Ljava/util/Map;
...
.method private static g(Ljava/lang/Class;)I
    ...
    .line 130
    :cond_0
    invoke-static {p0}, Landroid/arch/lifecycle/h;->e(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    .line 132
    sget-object v1, Landroid/arch/lifecycle/h;->cz:Ljava/util/Map;
    ...
    .line 137
    :cond_1
    sget-object v0, Landroid/arch/lifecycle/a;->bX:Landroid/arch/lifecycle/a;
    ...
    .line 144
    invoke-static {v0}, Landroid/arch/lifecycle/h;->h(Ljava/lang/Class;)Z
    ...
    .line 145
    invoke-static {v0}, Landroid/arch/lifecycle/h;->f(Ljava/lang/Class;)I
    ...
    sget-object v4, Landroid/arch/lifecycle/h;->cz:Ljava/util/Map;
    ...
    .line 152
    invoke-static {v6}, Landroid/arch/lifecycle/h;->h(Ljava/lang/Class;)Z
    ...
    .line 155
    :cond_5
    invoke-static {v6}, Landroid/arch/lifecycle/h;->f(Ljava/lang/Class;)I
    ...
    .line 161
    :cond_7
    sget-object v7, Landroid/arch/lifecycle/h;->cz:Ljava/util/Map;
    ...
    .line 164
    sget-object v0, Landroid/arch/lifecycle/h;->cz:Ljava/util/Map;
...
.method static l(Ljava/lang/Object;)Landroid/arch/lifecycle/GenericLifecycleObserver;
    .locals 4
