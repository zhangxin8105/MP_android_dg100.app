...
.field final cL:Landroid/arch/lifecycle/e;
...
.method constructor <init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/k;)V
    ...
    .line 352
    iput-object p1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cK:Landroid/arch/lifecycle/LiveData;
    ...
    .line 354
    iput-object p2, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cL:Landroid/arch/lifecycle/e;
...
.method public a(Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/c$a;)V
    ...
    .line 364
    iget-object p1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cL:Landroid/arch/lifecycle/e;

    invoke-interface {p1}, Landroid/arch/lifecycle/e;->getLifecycle()Landroid/arch/lifecycle/c;

    move-result-object p1

    invoke-virtual {p1}, Landroid/arch/lifecycle/c;->Y()Landroid/arch/lifecycle/c$b;

    move-result-object p1

    sget-object p2, Landroid/arch/lifecycle/c$b;->ci:Landroid/arch/lifecycle/c$b;

    if-ne p1, p2, :cond_0

    .line 365
    iget-object p1, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cK:Landroid/arch/lifecycle/LiveData;

    iget-object p2, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cM:Landroid/arch/lifecycle/k;
    ...
    .line 368
    :cond_0
    invoke-virtual {p0}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->ae()Z

    move-result p1

    invoke-virtual {p0, p1}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->k(Z)V
...
.method ae()Z
    ...
    .line 359
    iget-object v0, p0, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;->cL:Landroid/arch/lifecycle/e;
