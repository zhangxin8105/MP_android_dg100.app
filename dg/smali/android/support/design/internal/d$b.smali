...
.field private oL:Landroid/support/v7/view/menu/j;
...
.method constructor <init>(Landroid/support/design/internal/d;)V
    ...
    .line 375
    iput-object p1, p0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;
    ...
    iput-object p1, p0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;

    .line 376
    invoke-direct {p0}, Landroid/support/design/internal/d$b;->cZ()V
...
.method private cZ()V
    ...
    .line 482
    iget-boolean v1, v0, Landroid/support/design/internal/d$b;->oj:Z
    ...
    .line 485
    iput-boolean v1, v0, Landroid/support/design/internal/d$b;->oj:Z

    .line 486
    iget-object v2, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 492
    iget-object v3, v0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget-object v3, v3, Landroid/support/design/internal/d;->og:Landroid/support/v7/view/menu/h;
    ...
    .line 493
    iget-object v8, v0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget-object v8, v8, Landroid/support/design/internal/d;->og:Landroid/support/v7/view/menu/h;

    invoke-virtual {v8}, Landroid/support/v7/view/menu/h;->lW()Ljava/util/ArrayList;
    ...
    .line 495
    invoke-virtual {v0, v8}, Landroid/support/design/internal/d$b;->a(Landroid/support/v7/view/menu/j;)V
    ...
    .line 498
    invoke-virtual {v8, v4}, Landroid/support/v7/view/menu/j;->az(Z)V
    ...
    .line 504
    iget-object v10, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;

    new-instance v11, Landroid/support/design/internal/d$e;

    iget-object v12, v0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget v12, v12, Landroid/support/design/internal/d;->oI:I
    ...
    invoke-direct {v11, v8}, Landroid/support/design/internal/d$f;-><init>(Landroid/support/v7/view/menu/j;)V
    ...
    .line 516
    invoke-virtual {v14, v4}, Landroid/support/v7/view/menu/j;->az(Z)V
    ...
    .line 521
    :cond_6
    iget-object v15, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;

    new-instance v1, Landroid/support/design/internal/d$f;

    invoke-direct {v1, v14}, Landroid/support/design/internal/d$f;-><init>(Landroid/support/v7/view/menu/j;)V
    ...
    .line 525
    iget-object v1, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->size()I

    move-result v1

    invoke-direct {v0, v10, v1}, Landroid/support/design/internal/d$b;->q(II)V
    ...
    .line 531
    iget-object v5, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 535
    iget-object v6, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;

    new-instance v9, Landroid/support/design/internal/d$e;

    iget-object v10, v0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget v10, v10, Landroid/support/design/internal/d;->oI:I

    iget-object v11, v0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget v11, v11, Landroid/support/design/internal/d;->oI:I
    ...
    invoke-direct {v0, v7, v5}, Landroid/support/design/internal/d$b;->q(II)V
    ...
    invoke-direct {v5, v8}, Landroid/support/design/internal/d$f;-><init>(Landroid/support/v7/view/menu/j;)V

    .line 542
    iput-boolean v6, v5, Landroid/support/design/internal/d$f;->or:Z

    .line 543
    iget-object v8, v0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 547
    :cond_f
    iput-boolean v4, v0, Landroid/support/design/internal/d$b;->oj:Z
...
.method private q(II)V
    ...
    .line 552
    iget-object v0, p0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 553
    iput-boolean v1, v0, Landroid/support/design/internal/d$f;->or:Z
...
.method public a(Landroid/view/ViewGroup;I)Landroid/support/design/internal/d$j;
    ...
    iget-object p2, p0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget-object p2, p2, Landroid/support/design/internal/d;->oB:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget-object v0, v0, Landroid/support/design/internal/d;->oE:Landroid/view/LayoutInflater;
    ...
    iget-object v1, p0, Landroid/support/design/internal/d$b;->oJ:Landroid/support/design/internal/d;

    iget-object v1, v1, Landroid/support/design/internal/d;->nT:Landroid/view/View$OnClickListener;
...
.method public a(Landroid/support/design/internal/d$j;I)V
    ...
    invoke-virtual {p2}, Landroid/support/design/internal/d$e;->getPaddingTop()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/design/internal/d$e;->getPaddingBottom()I
    ...
    .line 449
    invoke-virtual {p2}, Landroid/support/design/internal/d$f;->db()Landroid/support/v7/view/menu/j;
    ...
    iget-object v0, v0, Landroid/support/design/internal/d;->ov:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v0, v0, Landroid/support/design/internal/d;->oF:Z
    ...
    iget v0, v0, Landroid/support/design/internal/d;->textAppearance:I
    ...
    iget-object v0, v0, Landroid/support/design/internal/d;->oG:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Landroid/support/design/internal/d;->oc:Landroid/graphics/drawable/Drawable;
    ...
    .line 435
    :goto_0
    invoke-static {p1, v0}, Landroid/support/v4/view/v;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 439
    iget-boolean v0, p2, Landroid/support/design/internal/d$f;->or:Z
    ...
    iget v0, v0, Landroid/support/design/internal/d;->itemHorizontalPadding:I
    ...
    iget v0, v0, Landroid/support/design/internal/d;->itemIconPadding:I
...
.method public a(Landroid/support/v7/view/menu/j;)V
    ...
    .line 558
    iget-object v0, p0, Landroid/support/design/internal/d$b;->oL:Landroid/support/v7/view/menu/j;
    ...
    .line 564
    :cond_1
    iput-object p1, p0, Landroid/support/design/internal/d$b;->oL:Landroid/support/v7/view/menu/j;
...
.method public d(Landroid/os/Bundle;)V
    ...
    .line 598
    iput-boolean v2, p0, Landroid/support/design/internal/d$b;->oj:Z

    .line 599
    iget-object v2, p0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 600
    iget-object v4, p0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Landroid/support/design/internal/d$f;->db()Landroid/support/v7/view/menu/j;
    ...
    .line 604
    invoke-virtual {p0, v4}, Landroid/support/design/internal/d$b;->a(Landroid/support/v7/view/menu/j;)V
    ...
    :cond_1
    :goto_1
    iput-boolean v1, p0, Landroid/support/design/internal/d$b;->oj:Z
    ...
    invoke-virtual {v2}, Landroid/support/design/internal/d$f;->db()Landroid/support/v7/view/menu/j;
    ...
    check-cast v2, Landroid/support/design/internal/f;
...
.method public da()Landroid/os/Bundle;
    ...
    .line 574
    iget-object v1, p0, Landroid/support/design/internal/d$b;->oL:Landroid/support/v7/view/menu/j;
    ...
    .line 575
    iget-object v2, p0, Landroid/support/design/internal/d$b;->oL:Landroid/support/v7/view/menu/j;
    ...
    .line 579
    iget-object v3, p0, Landroid/support/design/internal/d$b;->oK:Ljava/util/ArrayList;
    ...
    .line 585
    new-instance v6, Landroid/support/design/internal/f;

    invoke-direct {v6}, Landroid/support/design/internal/f;-><init>()V
...
.method public getItemViewType(I)I
    ...
    .line 398
    invoke-virtual {p1}, Landroid/support/design/internal/d$f;->db()Landroid/support/v7/view/menu/j;
...
.method public u(Z)V
    ...
    .line 639
    iput-boolean p1, p0, Landroid/support/design/internal/d$b;->oj:Z
