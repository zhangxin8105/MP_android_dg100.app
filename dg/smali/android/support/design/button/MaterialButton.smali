...
.field private final ln:Landroid/support/design/button/b;

.field private lo:Landroid/graphics/PorterDuff$Mode;

.field private lp:Landroid/content/res/ColorStateList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 139
    sget-object v2, Landroid/support/design/a$k;->MaterialButton:[I

    sget v4, Landroid/support/design/a$j;->Widget_MaterialComponents_Button:I
    ...
    .line 147
    sget p2, Landroid/support/design/a$k;->MaterialButton_iconPadding:I
    ...
    .line 148
    sget p2, Landroid/support/design/a$k;->MaterialButton_iconTintMode:I
    ...
    .line 149
    invoke-static {p2, p3}, Landroid/support/design/internal/i;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->lo:Landroid/graphics/PorterDuff$Mode;
    ...
    sget p3, Landroid/support/design/a$k;->MaterialButton_iconTint:I

    .line 153
    invoke-static {p2, p1, p3}, Landroid/support/design/e/a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->lp:Landroid/content/res/ColorStateList;
    ...
    sget p3, Landroid/support/design/a$k;->MaterialButton_icon:I

    invoke-static {p2, p1, p3}, Landroid/support/design/e/a;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 156
    sget p2, Landroid/support/design/a$k;->MaterialButton_iconGravity:I
    ...
    .line 158
    sget p2, Landroid/support/design/a$k;->MaterialButton_iconSize:I
    ...
    iput-object p2, p0, Landroid/support/design/button/MaterialButton;->ln:Landroid/support/design/button/b;

    .line 162
    iget-object p2, p0, Landroid/support/design/button/MaterialButton;->ln:Landroid/support/design/button/b;
    ...
    .line 167
    invoke-direct {p0}, Landroid/support/design/button/MaterialButton;->bT()V
...
.method private bT()V
    ...
    iget-object v1, p0, Landroid/support/design/button/MaterialButton;->lp:Landroid/content/res/ColorStateList;
    ...
    .line 542
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->lo:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/design/button/MaterialButton;->lo:Landroid/graphics/PorterDuff$Mode;
    ...
    iget v3, p0, Landroid/support/design/button/MaterialButton;->lq:I

    const/4 v4, 0x0

    iget v5, p0, Landroid/support/design/button/MaterialButton;->lq:I
    ...
    invoke-static {p0, v0, v1, v1, v1}, Landroid/support/v4/widget/q;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private bU()Z
    ...
    .line 744
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->ln:Landroid/support/design/button/b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->ln:Landroid/support/design/button/b;

    invoke-virtual {v0}, Landroid/support/design/button/b;->bW()Z
...
.method public getCornerRadius()I
    ...
    .line 717
    invoke-direct {p0}, Landroid/support/design/button/MaterialButton;->bU()Z
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getCornerRadius()I
...
.method public getIconTint()Landroid/content/res/ColorStateList;
    ...
    .line 509
    iget-object v0, p0, Landroid/support/design/button/MaterialButton;->lp:Landroid/content/res/ColorStateList;
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getRippleColor()Landroid/content/res/ColorStateList;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getStrokeColor()Landroid/content/res/ColorStateList;
...
.method public getStrokeWidth()I
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getStrokeWidth()I
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/design/button/MaterialButton;->ln:Landroid/support/design/button/b;
    ...
    invoke-virtual {p1, p5, p4}, Landroid/support/design/button/b;->o(II)V
...
.method protected onMeasure(II)V
    ...
    .line 347
    invoke-direct {p0}, Landroid/support/design/button/MaterialButton;->bS()Z
    ...
    .line 351
    :cond_2
    iget p1, p0, Landroid/support/design/button/MaterialButton;->lq:I

    if-eq p1, v1, :cond_3

    .line 352
    iput v1, p0, Landroid/support/design/button/MaterialButton;->lq:I
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setBackgroundColor(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0}, Landroid/support/design/button/b;->bV()V
...
.method public setCornerRadius(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setCornerRadius(I)V
...
.method public setIconTint(Landroid/content/res/ColorStateList;)V
    ...
    .line 483
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->lp:Landroid/content/res/ColorStateList;
...
.method public setIconTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 521
    iput-object p1, p0, Landroid/support/design/button/MaterialButton;->lo:Landroid/graphics/PorterDuff$Mode;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setRippleColor(Landroid/content/res/ColorStateList;)V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setStrokeColor(Landroid/content/res/ColorStateList;)V
...
.method public setStrokeWidth(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setStrokeWidth(I)V
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/button/b;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
