...
# instance fields
.field private final of:Landroid/support/design/internal/b;

.field private final og:Landroid/support/v7/view/menu/h;

.field private final oi:Landroid/support/design/internal/BottomNavigationMenuView;

.field private rt:Landroid/view/MenuInflater;

.field private ru:Landroid/support/design/widget/BottomNavigationView$b;

.field private rv:Landroid/support/design/widget/BottomNavigationView$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;
    ...
    .line 128
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;
    ...
    .line 130
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;

    iget-object v2, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;

    invoke-virtual {v1, v2}, Landroid/support/design/internal/b;->c(Landroid/support/design/internal/BottomNavigationMenuView;)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/internal/b;->setId(I)V

    .line 132
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;

    iget-object v3, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;

    invoke-virtual {v1, v3}, Landroid/support/design/internal/BottomNavigationMenuView;->setPresenter(Landroid/support/design/internal/b;)V

    .line 133
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;
    ...
    iget-object v4, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;

    invoke-virtual {v1, v3, v4}, Landroid/support/design/internal/b;->a(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V
    ...
    .line 138
    invoke-static/range {v5 .. v10}, Landroid/support/design/internal/h;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/support/v7/widget/ax;
    ...
    .line 148
    iget-object p3, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;
    ...
    .line 151
    invoke-virtual {v1, v4}, Landroid/support/design/internal/BottomNavigationMenuView;->N(I)Landroid/content/res/ColorStateList;
    ...
    .line 160
    invoke-virtual {p2, p3, v3}, Landroid/support/v7/widget/ax;->getResourceId(II)I
    ...
    .line 173
    invoke-virtual {p2, p3, v3}, Landroid/support/v7/widget/ax;->getDimensionPixelSize(II)I
    ...
    .line 177
    invoke-virtual {p2, p3, v1}, Landroid/support/v7/widget/ax;->getInteger(II)I
    ...
    .line 181
    invoke-virtual {p2, p3, v2}, Landroid/support/v7/widget/ax;->getBoolean(IZ)Z
    ...
    .line 191
    iget-object p2, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;
    ...
    .line 193
    invoke-direct {p0, p1}, Landroid/support/design/widget/BottomNavigationView;->F(Landroid/content/Context;)V

    .line 196
    :cond_6
    iget-object p1, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;
...
.method private F(Landroid/content/Context;)V
    ...
    .line 534
    invoke-static {p1, v1}, Landroid/support/v4/a/a;->j(Landroid/content/Context;I)I
...
.method static synthetic a(Landroid/support/design/widget/BottomNavigationView;)Landroid/support/design/widget/BottomNavigationView$a;
    ...
    .line 97
    iget-object p0, p0, Landroid/support/design/widget/BottomNavigationView;->rv:Landroid/support/design/widget/BottomNavigationView$a;
...
.method static synthetic b(Landroid/support/design/widget/BottomNavigationView;)Landroid/support/design/widget/BottomNavigationView$b;
    ...
    .line 97
    iget-object p0, p0, Landroid/support/design/widget/BottomNavigationView;->ru:Landroid/support/design/widget/BottomNavigationView$b;
...
.method private getMenuInflater()Landroid/view/MenuInflater;
    ...
    .line 544
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->rt:Landroid/view/MenuInflater;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->rt:Landroid/view/MenuInflater;
...
.method public getItemBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 373
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->oi:Landroid/support/design/internal/BottomNavigationMenuView;
...
.method public getMenu()Landroid/view/Menu;
    ...
    .line 240
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;
...
.method public inflateMenu(I)V
    ...
    .line 251
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/design/internal/b;->u(Z)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;

    invoke-virtual {v0, p1, v2}, Landroid/view/MenuInflater;->inflate(ILandroid/view/Menu;)V

    .line 253
    iget-object p1, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/support/design/internal/b;->u(Z)V

    .line 254
    iget-object p1, p0, Landroid/support/design/widget/BottomNavigationView;->of:Landroid/support/design/internal/b;

    invoke-virtual {p1, v1}, Landroid/support/design/internal/b;->t(Z)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 566
    invoke-virtual {p1}, Landroid/support/design/widget/BottomNavigationView$c;->getSuperState()Landroid/os/Parcelable;
    ...
    iget-object p1, p1, Landroid/support/design/widget/BottomNavigationView$c;->rx:Landroid/os/Bundle;

    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/h;->j(Landroid/os/Bundle;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/design/widget/BottomNavigationView$c;->rx:Landroid/os/Bundle;

    .line 555
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->og:Landroid/support/v7/view/menu/h;

    iget-object v2, v1, Landroid/support/design/widget/BottomNavigationView$c;->rx:Landroid/os/Bundle;

    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/h;->i(Landroid/os/Bundle;)V
...
.method public setItemHorizontalTranslationEnabled(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/BottomNavigationMenuView;->cP()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/internal/b;->t(Z)V
...
.method public setOnNavigationItemReselectedListener(Landroid/support/design/widget/BottomNavigationView$a;)V
    ...
    .line 234
    iput-object p1, p0, Landroid/support/design/widget/BottomNavigationView;->rv:Landroid/support/design/widget/BottomNavigationView$a;
...
.method public setOnNavigationItemSelectedListener(Landroid/support/design/widget/BottomNavigationView$b;)V
    ...
    .line 222
    iput-object p1, p0, Landroid/support/design/widget/BottomNavigationView;->ru:Landroid/support/design/widget/BottomNavigationView$b;
