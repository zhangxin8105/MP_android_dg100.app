...
.field private final rp:Landroid/support/v4/view/a/b$a;

.field private rq:Landroid/support/design/widget/BaseTransientBottomBar$d;

.field private rr:Landroid/support/design/widget/BaseTransientBottomBar$c;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 723
    invoke-static {p0, v0}, Landroid/support/v4/view/v;->f(Landroid/view/View;F)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rh:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rp:Landroid/support/v4/view/a/b$a;

    .line 738
    iget-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rh:Landroid/view/accessibility/AccessibilityManager;

    iget-object p2, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rp:Landroid/support/v4/view/a/b$a;
...
.method protected onAttachedToWindow()V
    ...
    .line 759
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rr:Landroid/support/design/widget/BaseTransientBottomBar$c;
...
.method protected onDetachedFromWindow()V
    ...
    .line 773
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rh:Landroid/view/accessibility/AccessibilityManager;

    iget-object v1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rp:Landroid/support/v4/view/a/b$a;
...
.method protected onLayout(ZIIII)V
    ...
    .line 751
    iget-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rq:Landroid/support/design/widget/BaseTransientBottomBar$d;

    if-eqz p1, :cond_0

    .line 752
    iget-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rq:Landroid/support/design/widget/BaseTransientBottomBar$d;
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/BaseTransientBottomBar$c;)V
    ...
    .line 784
    iput-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rr:Landroid/support/design/widget/BaseTransientBottomBar$c;
...
.method setOnLayoutChangeListener(Landroid/support/design/widget/BaseTransientBottomBar$d;)V
    ...
    .line 779
    iput-object p1, p0, Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;->rq:Landroid/support/design/widget/BaseTransientBottomBar$d;
