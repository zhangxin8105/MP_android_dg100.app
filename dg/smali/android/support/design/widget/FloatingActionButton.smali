...
.field private uG:Landroid/content/res/ColorStateList;

.field private uH:Landroid/graphics/PorterDuff$Mode;
...
.field final uL:Landroid/graphics/Rect;

.field private final uM:Landroid/graphics/Rect;

.field private final uN:Landroid/support/v7/widget/j;

.field private final uO:Landroid/support/design/d/c;

.field private uP:Landroid/support/design/widget/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uL:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uM:Landroid/graphics/Rect;
    ...
    .line 195
    invoke-static/range {v1 .. v6}, Landroid/support/design/internal/h;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    .line 202
    invoke-static {p1, v1, v2}, Landroid/support/design/e/a;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v2

    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->lu:Landroid/content/res/ColorStateList;
    ...
    .line 205
    invoke-static {v2, v4}, Landroid/support/design/internal/i;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->lt:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->lw:Landroid/content/res/ColorStateList;
    ...
    iput v2, p0, Landroid/support/design/widget/FloatingActionButton;->uI:I
    ...
    iput-boolean v5, p0, Landroid/support/design/widget/FloatingActionButton;->uK:Z
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/j;-><init>(Landroid/widget/ImageView;)V

    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->uN:Landroid/support/v7/widget/j;

    .line 230
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->uN:Landroid/support/v7/widget/j;
    ...
    iput-object p2, p0, Landroid/support/design/widget/FloatingActionButton;->uO:Landroid/support/design/d/c;
    ...
    iget-object p3, p0, Landroid/support/design/widget/FloatingActionButton;->lu:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->lt:Landroid/graphics/PorterDuff$Mode;

    iget-object v5, p0, Landroid/support/design/widget/FloatingActionButton;->lw:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, v2}, Landroid/support/design/widget/h;->setElevation(F)V
    ...
    invoke-virtual {p2, v4}, Landroid/support/design/widget/h;->t(F)V
    ...
    invoke-virtual {p2, v3}, Landroid/support/design/widget/h;->u(F)V
    ...
    invoke-virtual {p2, p3}, Landroid/support/design/widget/h;->aA(I)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/design/widget/h;->setShowMotionSpec(Landroid/support/design/a/h;)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/design/widget/h;->setHideMotionSpec(Landroid/support/design/a/h;)V
...
.method private az(I)I
    .locals 3

    .line 702
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->uI:I

    if-eqz v0, :cond_0

    .line 703
    iget p1, p0, Landroid/support/design/widget/FloatingActionButton;->uI:I
    ...
    .line 713
    invoke-direct {p0, v2}, Landroid/support/design/widget/FloatingActionButton;->az(I)I
    ...
    .line 714
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->az(I)I
...
.method static synthetic c(Landroid/support/design/widget/FloatingActionButton;)I
    ...
    .line 93
    iget p0, p0, Landroid/support/design/widget/FloatingActionButton;->uJ:I
...
.method private e(Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->uL:Landroid/graphics/Rect;
...
.method private eA()V
    ...
    .line 444
    :cond_0
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->uG:Landroid/content/res/ColorStateList;
    ...
    .line 450
    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->uH:Landroid/graphics/PorterDuff$Mode;
...
.method private eC()Landroid/support/design/widget/h;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/i;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/o;)V
...
.method private getImpl()Landroid/support/design/widget/h;
    ...
    .line 1248
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uP:Landroid/support/design/widget/h;

    if-nez v0, :cond_0

    .line 1249
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->eC()Landroid/support/design/widget/h;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uP:Landroid/support/design/widget/h;
...
.method public c(Landroid/graphics/Rect;)Z
    ...
    .line 784
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->e(Landroid/graphics/Rect;)V
...
.method public cM()Z
    ...
    .line 558
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uO:Landroid/support/design/d/c;

    invoke-virtual {v0}, Landroid/support/design/d/c;->cM()Z
...
.method public eB()Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->eB()Z
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 328
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->lu:Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 354
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->lt:Landroid/graphics/PorterDuff$Mode;
...
.method public getCompatHoveredFocusedTranslationZ()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->eG()F
...
.method public getCompatPressedTranslationZ()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->eH()F
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->getContentBackground()Landroid/graphics/drawable/Drawable;
...
.method public getHideMotionSpec()Landroid/support/design/a/h;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->getHideMotionSpec()Landroid/support/design/a/h;
...
.method public getRippleColor()I
    ...
    .line 274
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->lw:Landroid/content/res/ColorStateList;
...
.method public getShowMotionSpec()Landroid/support/design/a/h;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->getShowMotionSpec()Landroid/support/design/a/h;
...
.method getSizeDimension()I
    ...
    invoke-direct {p0, v0}, Landroid/support/design/widget/FloatingActionButton;->az(I)I
...
.method public getSupportImageTintList()Landroid/content/res/ColorStateList;
    ...
    .line 421
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uG:Landroid/content/res/ColorStateList;
...
.method public getSupportImageTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 435
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uH:Landroid/graphics/PorterDuff$Mode;
...
.method public getUseCompatPadding()Z
    ...
    .line 596
    iget-boolean v0, p0, Landroid/support/design/widget/FloatingActionButton;->uK:Z
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->eJ()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->onAttachedToWindow()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/h;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->uJ:I
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/h;->eN()V
    ...
    .line 260
    iget-object p2, p0, Landroid/support/design/widget/FloatingActionButton;->uL:Landroid/graphics/Rect;

    iget p2, p2, Landroid/graphics/Rect;->left:I

    add-int/2addr p2, p1

    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uL:Landroid/graphics/Rect;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 766
    invoke-virtual {p1}, Landroid/support/design/i/a;->getSuperState()Landroid/os/Parcelable;
    ...
    iget-object p1, p1, Landroid/support/design/i/a;->qb:Landroid/support/v4/h/l;

    const-string v1, "expandableWidgetHelper"

    .line 769
    invoke-virtual {p1, v1}, Landroid/support/v4/h/l;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 752
    iget-object v0, v1, Landroid/support/design/i/a;->qb:Landroid/support/v4/h/l;

    const-string v2, "expandableWidgetHelper"

    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->uO:Landroid/support/design/d/c;
    ...
    .line 752
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/h/l;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 843
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uM:Landroid/graphics/Rect;

    invoke-virtual {p0, v0}, Landroid/support/design/widget/FloatingActionButton;->c(Landroid/graphics/Rect;)Z
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 340
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->lu:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->setBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 367
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->lt:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCompatHoveredFocusedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->t(F)V
...
.method public setCompatPressedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->u(F)V
...
.method public setCustomSize(I)V
    ...
    .line 674
    iput p1, p0, Landroid/support/design/widget/FloatingActionButton;->uI:I
...
.method public setHideMotionSpec(Landroid/support/design/a/h;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->setHideMotionSpec(Landroid/support/design/a/h;)V
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/h;->eI()V
...
.method public setImageResource(I)V
    ...
    .line 478
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->uN:Landroid/support/v7/widget/j;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    .line 314
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->lw:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/h;->setRippleColor(Landroid/content/res/ColorStateList;)V
...
.method public setShowMotionSpec(Landroid/support/design/a/h;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/h;->setShowMotionSpec(Landroid/support/design/a/h;)V
...
.method public setSize(I)V
    ...
    .line 613
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->uI:I
...
.method public setSupportImageTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 413
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->uG:Landroid/content/res/ColorStateList;

    .line 414
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->eA()V
...
.method public setSupportImageTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 427
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->uH:Landroid/graphics/PorterDuff$Mode;
...
.method public setUseCompatPadding(Z)V
    ...
    .line 582
    iput-boolean p1, p0, Landroid/support/design/widget/FloatingActionButton;->uK:Z
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/h;->eM()V
