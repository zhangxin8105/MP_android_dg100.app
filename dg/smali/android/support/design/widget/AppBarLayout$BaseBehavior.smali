...
.field private qM:Landroid/animation/ValueAnimator;
...
.field private qR:Landroid/support/design/widget/AppBarLayout$BaseBehavior$a;
...
.method public constructor <init>()V
    ...
    .line 893
    iput v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qN:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 893
    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qN:I
...
.method static synthetic a(Landroid/support/design/widget/AppBarLayout$BaseBehavior;)I
    ...
    .line 869
    iget p0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qK:I
...
.method private a(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1083
    invoke-virtual {v2}, Landroid/support/design/widget/AppBarLayout$b;->dy()I

    move-result v5

    const/16 v6, 0x20

    invoke-static {v5, v6}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->u(II)Z
...
.method private a(ILandroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
    ...
    .line 994
    :cond_1
    invoke-static {p3, v0}, Landroid/support/v4/view/v;->p(Landroid/view/View;I)V
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 1102
    invoke-virtual {v3}, Landroid/support/design/widget/AppBarLayout$b;->dy()I
    ...
    .line 1114
    invoke-static {v4, v1}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->u(II)Z
    ...
    .line 1116
    invoke-static {v2}, Landroid/support/v4/view/v;->an(Landroid/view/View;)I
    ...
    .line 1117
    invoke-static {v4, v7}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->u(II)Z
    ...
    .line 1129
    invoke-static {v4, v2}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->u(II)Z
    ...
    invoke-static {v5, v0, v1}, Landroid/support/v4/c/a;->h(III)I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;II)V
    ...
    .line 1050
    iget-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qM:Landroid/animation/ValueAnimator;
    ...
    .line 1056
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qM:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qM:Landroid/animation/ValueAnimator;

    .line 1058
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qM:Landroid/animation/ValueAnimator;

    sget-object v2, Landroid/support/design/a/a;->kC:Landroid/animation/TimeInterpolator;
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIZ)V
    ...
    .line 1384
    invoke-virtual {v1}, Landroid/support/design/widget/AppBarLayout$b;->dy()I
    ...
    :cond_3
    :goto_2
    invoke-virtual {p2, p3}, Landroid/support/design/widget/AppBarLayout;->z(Z)Z
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;)Z
    ...
    .line 936
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->dt()Z
...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1333
    invoke-virtual {v5}, Landroid/support/design/widget/AppBarLayout$b;->dz()Landroid/view/animation/Interpolator;
    ...
    .line 1338
    invoke-virtual {v5}, Landroid/support/design/widget/AppBarLayout$b;->dy()I
    ...
    .line 1346
    invoke-static {v4}, Landroid/support/v4/view/v;->an(Landroid/view/View;)I
    ...
    .line 1350
    :cond_0
    invoke-static {v4}, Landroid/support/v4/view/v;->at(Landroid/view/View;)Z
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/AppBarLayout$ScrollingViewBehavior;->eZ()I
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    .line 1281
    invoke-static {p3, p4, p5}, Landroid/support/v4/c/a;->h(III)I
    ...
    .line 1284
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->ds()Z
    ...
    .line 1288
    :goto_0
    invoke-virtual {p0, p3}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->Y(I)Z
    ...
    .line 1293
    iput p3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qK:I
    ...
    .line 1300
    invoke-virtual {p1, p2}, Landroid/support/design/widget/CoordinatorLayout;->z(Landroid/view/View;)V

    .line 1304
    :cond_1
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->dx()I

    move-result p3

    invoke-virtual {p2, p3}, Landroid/support/design/widget/AppBarLayout;->W(I)V
    ...
    .line 1316
    :cond_3
    iput v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qK:I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    .line 1497
    invoke-virtual {p3}, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1498
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qV:I

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qN:I

    .line 1499
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qW:F

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qP:F

    .line 1500
    iget-boolean p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qX:Z

    iput-boolean p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qO:Z
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
    ...
    .line 1006
    iget v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qL:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qQ:Ljava/lang/ref/WeakReference;
...
.method a(Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1234
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qR:Landroid/support/design/widget/AppBarLayout$BaseBehavior$a;
    ...
    .line 1240
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qQ:Ljava/lang/ref/WeakReference;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    .line 1184
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qN:I
    ...
    .line 1185
    iget v0, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qN:I
    ...
    .line 1187
    iget-boolean v3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qO:Z
    ...
    iget v3, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qP:F
    ...
    :cond_6
    :goto_2
    invoke-virtual {p2}, Landroid/support/design/widget/AppBarLayout;->dv()V
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/c/a;->h(III)I

    move-result v0

    .line 1217
    invoke-virtual {p0, v0}, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->Y(I)Z
    ...
    invoke-virtual {p2, p1}, Landroid/support/design/widget/AppBarLayout;->W(I)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;Landroid/view/View;II)Z
    ...
    .line 920
    iget-object p2, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qM:Landroid/animation/ValueAnimator;
    ...
    .line 926
    iput-object p2, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qQ:Ljava/lang/ref/WeakReference;

    .line 929
    iput p6, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qL:I
...
.method public d(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    .line 1471
    invoke-super {p0, p1, p2}, Landroid/support/design/widget/j;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    .line 1481
    iput v3, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qV:I
    ...
    :cond_0
    iput-boolean v2, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qX:Z
    ...
    iput p1, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->qW:F
...
.method dw()I
    ...
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->qK:I
...
.method synthetic j(Landroid/view/View;)I
    .locals 0
...
.method synthetic k(Landroid/view/View;)I
    .locals 0
...
.method synthetic l(Landroid/view/View;)Z
    .locals 0
