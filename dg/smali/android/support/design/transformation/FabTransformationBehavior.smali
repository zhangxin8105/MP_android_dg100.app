...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qi:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qj:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qk:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->ql:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qi:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qj:Landroid/graphics/RectF;
    ...
    iput-object p1, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qk:Landroid/graphics/RectF;
    ...
    iput-object p1, p0, Landroid/support/design/transformation/FabTransformationBehavior;->ql:[I
...
.method private a(Landroid/support/design/transformation/FabTransformationBehavior$a;Landroid/support/design/a/i;FF)F
    ...
    .line 613
    invoke-virtual {p2}, Landroid/support/design/a/i;->bK()J
    ...
    .line 617
    iget-object p1, p1, Landroid/support/design/transformation/FabTransformationBehavior$a;->qr:Landroid/support/design/a/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;

    move-result-object p1

    .line 618
    invoke-virtual {p1}, Landroid/support/design/a/i;->bK()J
...
.method private a(Landroid/view/View;Landroid/view/View;Landroid/support/design/a/j;)F
    ...
    .line 492
    iget-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qj:Landroid/graphics/RectF;

    .line 493
    iget-object v1, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qk:Landroid/graphics/RectF;
    ...
    .line 499
    iget p1, p3, Landroid/support/design/a/j;->gravity:I
    ...
    .line 512
    :goto_0
    iget p2, p3, Landroid/support/design/a/j;->kO:F
...
.method private a(Landroid/view/View;Landroid/graphics/RectF;)V
    ...
    .line 545
    iget-object v0, p0, Landroid/support/design/transformation/FabTransformationBehavior;->ql:[I
...
.method private a(Landroid/view/View;Landroid/support/design/transformation/FabTransformationBehavior$a;Landroid/support/design/a/i;Landroid/support/design/a/i;FFFFLandroid/graphics/RectF;)V
    ...
    .line 597
    iget-object p4, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qi:Landroid/graphics/Rect;

    .line 598
    invoke-virtual {p1, p4}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 599
    iget-object p5, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qj:Landroid/graphics/RectF;

    .line 600
    invoke-virtual {p5, p4}, Landroid/graphics/RectF;->set(Landroid/graphics/Rect;)V

    .line 603
    iget-object p4, p0, Landroid/support/design/transformation/FabTransformationBehavior;->qk:Landroid/graphics/RectF;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;FFLjava/util/List;Ljava/util/List;)V
    ...
    .line 334
    instance-of v2, v8, Landroid/support/design/circularreveal/c;
    ...
    check-cast v13, Landroid/support/design/circularreveal/c;

    .line 339
    iget-object v2, v9, Landroid/support/design/transformation/FabTransformationBehavior$a;->qs:Landroid/support/design/a/j;
    ...
    .line 340
    iget-object v3, v9, Landroid/support/design/transformation/FabTransformationBehavior$a;->qs:Landroid/support/design/a/j;
    ...
    iget-object v4, v12, Landroid/support/design/transformation/FabTransformationBehavior;->qi:Landroid/graphics/Rect;

    invoke-virtual {v0, v4}, Landroid/support/design/widget/FloatingActionButton;->c(Landroid/graphics/Rect;)Z

    .line 342
    iget-object v0, v12, Landroid/support/design/transformation/FabTransformationBehavior;->qi:Landroid/graphics/Rect;
    ...
    .line 345
    iget-object v0, v9, Landroid/support/design/transformation/FabTransformationBehavior$a;->qr:Landroid/support/design/a/h;

    const-string v4, "expansion"

    invoke-virtual {v0, v4}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;
    ...
    invoke-direct {v0, v2, v3, v10}, Landroid/support/design/circularreveal/c$d;-><init>(FFF)V

    invoke-interface {v13, v0}, Landroid/support/design/circularreveal/c;->setRevealInfo(Landroid/support/design/circularreveal/c$d;)V

    :cond_1
    if-eqz p4, :cond_2

    .line 353
    invoke-interface {v13}, Landroid/support/design/circularreveal/c;->getRevealInfo()Landroid/support/design/circularreveal/c$d;

    move-result-object v0

    iget v0, v0, Landroid/support/design/circularreveal/c$d;->nx:F
    ...
    .line 355
    invoke-static/range {v14 .. v19}, Landroid/support/design/widget/m;->a(FFFFFF)F

    move-result v0

    .line 359
    invoke-static {v13, v2, v3, v0}, Landroid/support/design/circularreveal/a;->a(Landroid/support/design/circularreveal/c;FFF)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v12, v13}, Landroid/support/design/transformation/FabTransformationBehavior$4;-><init>(Landroid/support/design/transformation/FabTransformationBehavior;Landroid/support/design/circularreveal/c;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 375
    invoke-virtual {v11}, Landroid/support/design/a/i;->bK()J
    ...
    iget v6, v0, Landroid/support/design/circularreveal/c$d;->nx:F

    .line 385
    invoke-static {v13, v2, v3, v10}, Landroid/support/design/circularreveal/a;->a(Landroid/support/design/circularreveal/c;FFF)Landroid/animation/Animator;
    ...
    .line 408
    invoke-static {v13}, Landroid/support/design/circularreveal/a;->a(Landroid/support/design/circularreveal/c;)Landroid/animation/Animator$AnimatorListener;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 187
    invoke-static {p2}, Landroid/support/v4/view/v;->ap(Landroid/view/View;)F

    move-result p7

    invoke-static {p1}, Landroid/support/v4/view/v;->ap(Landroid/view/View;)F
    ...
    .line 199
    :goto_0
    iget-object p2, p5, Landroid/support/design/transformation/FabTransformationBehavior$a;->qr:Landroid/support/design/a/h;

    const-string p3, "elevation"

    invoke-virtual {p2, p3}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    .line 213
    iget-object v4, v3, Landroid/support/design/transformation/FabTransformationBehavior$a;->qs:Landroid/support/design/a/j;
    ...
    .line 214
    iget-object v5, v3, Landroid/support/design/transformation/FabTransformationBehavior$a;->qs:Landroid/support/design/a/j;
    ...
    .line 227
    :cond_2
    iget-object v6, v3, Landroid/support/design/transformation/FabTransformationBehavior$a;->qr:Landroid/support/design/a/h;

    const-string v7, "translationXCurveUpwards"

    invoke-virtual {v6, v7}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;

    move-result-object v6

    .line 228
    iget-object v7, v3, Landroid/support/design/transformation/FabTransformationBehavior$a;->qr:Landroid/support/design/a/h;

    const-string v8, "translationYCurveUpwards"

    invoke-virtual {v7, v8}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;
...
.method private b(Landroid/view/View;Landroid/view/View;Landroid/support/design/a/j;)F
    ...
    .line 537
    :goto_0
    iget p2, p3, Landroid/support/design/a/j;->kP:F
...
.method private b(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 272
    instance-of v0, p2, Landroid/support/design/circularreveal/c;
    ...
    check-cast v0, Landroid/support/design/circularreveal/c;
    ...
    .line 291
    :cond_2
    sget-object p3, Landroid/support/design/a/e;->kF:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Landroid/support/design/a/h;->at(Ljava/lang/String;)Landroid/support/design/a/i;
    ...
    invoke-direct {p2, p0, v0, p1}, Landroid/support/design/transformation/FabTransformationBehavior$3;-><init>(Landroid/support/design/transformation/FabTransformationBehavior;Landroid/support/design/circularreveal/c;Landroid/graphics/drawable/Drawable;)V
...
.method private c(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 419
    instance-of p7, p2, Landroid/support/design/circularreveal/c;
    ...
    .line 422
    :cond_0
    check-cast p2, Landroid/support/design/circularreveal/c;

    .line 424
    invoke-direct {p0, p1}, Landroid/support/design/transformation/FabTransformationBehavior;->i(Landroid/view/View;)I
    ...
    .line 430
    invoke-interface {p2, p1}, Landroid/support/design/circularreveal/c;->setCircularRevealScrimColor(I)V

    .line 432
    :cond_1
    sget-object p1, Landroid/support/design/circularreveal/c$c;->nw:Landroid/util/Property;
    ...
    .line 438
    :cond_2
    sget-object p3, Landroid/support/design/circularreveal/c$c;->nw:Landroid/util/Property;
    ...
    .line 445
    :goto_0
    invoke-static {}, Landroid/support/design/a/c;->bJ()Landroid/support/design/a/c;
...
.method private d(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 462
    :cond_0
    instance-of p1, p2, Landroid/support/design/circularreveal/c;

    if-eqz p1, :cond_1

    sget p1, Landroid/support/design/circularreveal/b;->nl:I
    ...
    .line 468
    :cond_1
    invoke-direct {p0, p2}, Landroid/support/design/transformation/FabTransformationBehavior;->g(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 477
    sget-object p3, Landroid/support/design/a/d;->kE:Landroid/util/Property;
    ...
    .line 479
    :cond_3
    sget-object p2, Landroid/support/design/a/d;->kE:Landroid/util/Property;
...
.method private g(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 633
    sget v0, Landroid/support/design/a$f;->mtrl_child_content_container:I
    ...
    .line 635
    invoke-direct {p0, v0}, Landroid/support/design/transformation/FabTransformationBehavior;->h(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 645
    :cond_1
    invoke-direct {p0, p1}, Landroid/support/design/transformation/FabTransformationBehavior;->h(Landroid/view/View;)Landroid/view/ViewGroup;
...
.method private i(Landroid/view/View;)I
    ...
    .line 658
    invoke-static {p1}, Landroid/support/v4/view/v;->aw(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout$e;)V
    ...
    .line 104
    iget v0, p1, Landroid/support/design/widget/CoordinatorLayout$e;->um:I
    ...
    .line 107
    iput v0, p1, Landroid/support/design/widget/CoordinatorLayout$e;->um:I
...
.method protected b(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, v0, v11}, Landroid/support/design/transformation/FabTransformationBehavior;->b(Landroid/content/Context;Z)Landroid/support/design/transformation/FabTransformationBehavior$a;
    ...
    .line 125
    :cond_0
    iget-object v9, v10, Landroid/support/design/transformation/FabTransformationBehavior;->qj:Landroid/graphics/RectF;
...
.method protected abstract b(Landroid/content/Context;Z)Landroid/support/design/transformation/FabTransformationBehavior$a;
.end method
