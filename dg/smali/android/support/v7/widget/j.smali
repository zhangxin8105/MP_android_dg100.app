...
.field private final aiq:Landroid/widget/ImageView;

.field private air:Landroid/support/v7/widget/av;

.field private ais:Landroid/support/v7/widget/av;
...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    .line 46
    iput-object p1, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;
...
.method private nr()Z
    ...
    .line 178
    iget-object v0, p0, Landroid/support/v7/widget/j;->air:Landroid/support/v7/widget/av;
...
.method private y(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 196
    iget-object v0, p0, Landroid/support/v7/widget/j;->ahS:Landroid/support/v7/widget/av;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->ahS:Landroid/support/v7/widget/av;
    ...
    .line 202
    iget-object v1, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;

    invoke-static {v1}, Landroid/support/v4/widget/l;->b(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/l;->c(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    .line 50
    iget-object v0, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;
    ...
    .line 53
    :try_start_0
    iget-object p2, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/ax;->getResourceId(II)I
    ...
    invoke-static {p2, v1}, Landroid/support/v7/c/a/a;->h(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 67
    invoke-static {p2}, Landroid/support/v7/widget/z;->D(Landroid/graphics/drawable/Drawable;)V
...
.method getSupportImageTintList()Landroid/content/res/ColorStateList;
    ...
    .line 119
    iget-object v0, p0, Landroid/support/v7/widget/j;->ais:Landroid/support/v7/widget/av;
...
.method nv()V
    ...
    .line 143
    invoke-direct {p0}, Landroid/support/v7/widget/j;->nr()Z
    ...
    .line 144
    invoke-direct {p0, v0}, Landroid/support/v7/widget/j;->y(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 150
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/j;->ais:Landroid/support/v7/widget/av;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;
    ...
    .line 153
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/j;->air:Landroid/support/v7/widget/av;
...
.method public setImageResource(I)V
    ...
    .line 88
    invoke-static {p1}, Landroid/support/v7/widget/z;->D(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 92
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/j;->aiq:Landroid/widget/ImageView;
    ...
    .line 95
    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/widget/j;->nv()V
...
.method setSupportImageTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->ais:Landroid/support/v7/widget/av;
    ...
    .line 114
    iget-object p1, p0, Landroid/support/v7/widget/j;->ais:Landroid/support/v7/widget/av;
