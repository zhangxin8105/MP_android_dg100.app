...
.field private aiG:Landroid/widget/SpinnerAdapter;

.field private final aiH:Z

.field aiI:Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/AppCompatSpinner;->aiF:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->ahM:Landroid/support/v7/widget/f;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/AppCompatSpinner;->afb:Landroid/content/Context;
    ...
    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/ax;->getResourceId(II)I
    ...
    :goto_0
    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->afb:Landroid/content/Context;

    .line 216
    :goto_1
    iget-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->afb:Landroid/content/Context;
    ...
    .line 220
    :try_start_0
    sget-object p5, Landroid/support/v7/widget/AppCompatSpinner;->aiF:[I
    ...
    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/ax;->getLayoutDimension(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiJ:I

    .line 240
    sget v1, Landroid/support/v7/a/a$j;->Spinner_android_popupBackground:I

    .line 241
    invoke-virtual {p5, v1}, Landroid/support/v7/widget/ax;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/AppCompatSpinner$b;->v(Ljava/lang/CharSequence;)V

    .line 243
    invoke-virtual {p5}, Landroid/support/v7/widget/ax;->recycle()V

    .line 245
    iput-object p4, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiI:Landroid/support/v7/widget/AppCompatSpinner$b;
    ...
    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->acG:Landroid/support/v7/widget/ad;

    .line 263
    :cond_6
    sget p4, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/ax;->getTextArray(I)[Ljava/lang/CharSequence;
    ...
    .line 273
    iput-boolean v3, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiH:Z

    .line 277
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiG:Landroid/widget/SpinnerAdapter;
    ...
    .line 279
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiG:Landroid/widget/SpinnerAdapter;

    .line 282
    :cond_8
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->ahM:Landroid/support/v7/widget/f;
...
.method protected drawableStateChanged()V
    ...
    .line 537
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->ahM:Landroid/support/v7/widget/f;
...
.method public getDropDownHorizontalOffset()I
    ...
    .line 358
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiI:Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method public getDropDownWidth()I
    ...
    .line 378
    iget v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiJ:I
...
.method public getPopupContext()Landroid/content/Context;
    ...
    .line 291
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->afb:Landroid/content/Context;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$b;->getHintText()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    .line 423
    iget-object p2, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiI:Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 413
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->acG:Landroid/support/v7/widget/ad;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 389
    iget-boolean v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiH:Z

    if-nez v0, :cond_0

    .line 390
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiG:Landroid/widget/SpinnerAdapter;
    ...
    .line 398
    :goto_0
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiI:Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method public setDropDownWidth(I)V
    ...
    .line 369
    iput p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->aiJ:I
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/AppCompatSpinner$b;->v(Ljava/lang/CharSequence;)V
