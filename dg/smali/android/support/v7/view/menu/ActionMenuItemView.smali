...
.field acE:Landroid/support/v7/view/menu/j;

.field acF:Landroid/support/v7/view/menu/h$b;

.field private acG:Landroid/support/v7/widget/ad;

.field acH:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 74
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->lz()Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acI:Z
    ...
    .line 82
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acL:I
    ...
    .line 86
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acK:I
...
.method private lA()V
    ...
    .line 188
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KK:Ljava/lang/CharSequence;
    ...
    .line 189
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Wz:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acE:Landroid/support/v7/view/menu/j;

    .line 190
    invoke-virtual {v2}, Landroid/support/v7/view/menu/j;->mp()Z

    move-result v2

    if-eqz v2, :cond_0

    iget-boolean v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acI:Z

    if-nez v2, :cond_1

    iget-boolean v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acJ:Z
    ...
    .line 192
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KK:Ljava/lang/CharSequence;
    ...
    .line 207
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acE:Landroid/support/v7/view/menu/j;
...
.method public a(Landroid/support/v7/view/menu/j;I)V
    ...
    .line 124
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acE:Landroid/support/v7/view/menu/j;
    ...
    .line 133
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acG:Landroid/support/v7/widget/ad;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acG:Landroid/support/v7/widget/ad;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 150
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acF:Landroid/support/v7/view/menu/h$b;
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/h$b;->b(Landroid/support/v7/view/menu/j;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acI:Z

    .line 95
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->lA()V
...
.method protected onMeasure(II)V
    ...
    .line 270
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acK:I
    ...
    .line 289
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Wz:Landroid/graphics/drawable/Drawable;
    ...
    .line 293
    iget-object p2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Wz:Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acG:Landroid/support/v7/widget/ad;
    ...
    .line 142
    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/ad;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    .line 179
    iget-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acJ:Z

    if-eq v0, p1, :cond_0

    .line 180
    iput-boolean p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acJ:Z

    .line 181
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acE:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/j;->ml()V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 215
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Wz:Landroid/graphics/drawable/Drawable;
    ...
    .line 219
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acL:I
    ...
    .line 221
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acL:I
    ...
    .line 226
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acL:I
...
.method public setItemInvoker(Landroid/support/v7/view/menu/h$b;)V
    ...
    .line 156
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acF:Landroid/support/v7/view/menu/h$b;
...
.method public setPopupCallback(Landroid/support/v7/view/menu/ActionMenuItemView$b;)V
    ...
    .line 160
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->acH:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 247
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KK:Ljava/lang/CharSequence;
