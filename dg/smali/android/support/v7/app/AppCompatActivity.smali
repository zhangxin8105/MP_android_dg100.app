...
.field private Xz:Landroid/support/v7/app/d;
...
.method public constructor <init>()V
    ...
    .line 66
    iput v0, p0, Landroid/support/v7/app/AppCompatActivity;->XA:I
...
.method public a(Landroid/support/v4/app/af;)V
    ...
    .line 348
    invoke-virtual {p1, p0}, Landroid/support/v4/app/af;->g(Landroid/app/Activity;)Landroid/support/v4/app/af;
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 155
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->kl()Landroid/support/v7/app/d;
...
.method public closeOptionsMenu()V
    ...
    .line 586
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->ki()Landroid/support/v7/app/a;
    ...
    .line 588
    invoke-virtual {v0}, Landroid/support/v7/app/a;->kb()Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 532
    invoke-virtual {v1, p1}, Landroid/support/v7/app/a;->c(Landroid/view/KeyEvent;)Z
...
.method public getResources()Landroid/content/res/Resources;
    ...
    .line 540
    iget-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->RH:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->RH:Landroid/content/res/Resources;
...
.method public hu()Landroid/content/Intent;
    .locals 1

    .line 431
    invoke-static {p0}, Landroid/support/v4/app/w;->e(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public ki()Landroid/support/v7/app/a;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/d;->ki()Landroid/support/v7/app/a;
...
.method public kj()Z
    ...
    .line 393
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->hu()Landroid/content/Intent;
    ...
    .line 396
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->l(Landroid/content/Intent;)Z
    ...
    .line 397
    invoke-static {p0}, Landroid/support/v4/app/af;->K(Landroid/content/Context;)Landroid/support/v4/app/af;

    move-result-object v0

    .line 398
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->a(Landroid/support/v4/app/af;)V

    .line 399
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->b(Landroid/support/v4/app/af;)V

    .line 400
    invoke-virtual {v0}, Landroid/support/v4/app/af;->startActivities()V
    ...
    .line 412
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->m(Landroid/content/Intent;)V
...
.method public kl()Landroid/support/v7/app/d;
    .locals 1

    .line 519
    iget-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->Xz:Landroid/support/v7/app/d;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatActivity;->Xz:Landroid/support/v7/app/d;
...
.method public l(Landroid/content/Intent;)Z
    ...
    .line 448
    invoke-static {p0, p1}, Landroid/support/v4/app/w;->d(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 166
    iget-object v1, p0, Landroid/support/v7/app/AppCompatActivity;->RH:Landroid/content/res/Resources;
...
.method public onContentChanged()V
    ...
    .line 470
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->kk()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 72
    invoke-virtual {v0}, Landroid/support/v7/app/d;->km()V

    .line 73
    invoke-virtual {v0, p1}, Landroid/support/v7/app/d;->onCreate(Landroid/os/Bundle;)V

    .line 74
    invoke-virtual {v0}, Landroid/support/v7/app/d;->kn()Z

    move-result v0

    if-eqz v0, :cond_1

    iget v0, p0, Landroid/support/v7/app/AppCompatActivity;->XA:I
    ...
    iget v1, p0, Landroid/support/v7/app/AppCompatActivity;->XA:I
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 202
    invoke-virtual {p1}, Landroid/support/v7/app/a;->getDisplayOptions()I
    ...
    .line 203
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatActivity;->kj()Z
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/d;->onPostCreate(Landroid/os/Bundle;)V
...
.method protected onTitleChanged(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/app/d;->setTitle(Ljava/lang/CharSequence;)V
...
.method public openOptionsMenu()V
    ...
    .line 579
    invoke-virtual {v0}, Landroid/support/v7/app/a;->ka()Z
...
.method public setTheme(I)V
    ...
    .line 92
    iput p1, p0, Landroid/support/v7/app/AppCompatActivity;->XA:I
