...
.method constructor <init>(Landroid/support/v7/app/e;Landroid/view/Window$Callback;)V
    ...
    .line 2526
    iput-object p1, p0, Landroid/support/v7/app/e$c;->Yt:Landroid/support/v7/app/e;
...
.method final a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroid/support/v7/app/e$c;->Yt:Landroid/support/v7/app/e;

    iget-object v1, v1, Landroid/support/v7/app/e;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1, p1}, Landroid/support/v7/view/f$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    .line 2624
    iget-object p1, p0, Landroid/support/v7/app/e$c;->Yt:Landroid/support/v7/app/e;

    .line 2625
    invoke-virtual {p1, v0}, Landroid/support/v7/app/e;->c(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    .line 2629
    invoke-virtual {v0, p1}, Landroid/support/v7/view/f$a;->d(Landroid/support/v7/view/b;)Landroid/view/ActionMode;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 2532
    iget-object v0, p0, Landroid/support/v7/app/e$c;->Yt:Landroid/support/v7/app/e;
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    .line 2588
    iget-object p2, p0, Landroid/support/v7/app/e$c;->Yt:Landroid/support/v7/app/e;

    invoke-virtual {p2, p1}, Landroid/support/v7/app/e;->cQ(I)V
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/app/e;->cP(I)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    .line 2573
    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/h;->ay(Z)V
    ...
    .line 2579
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/h;->ay(Z)V
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/app/e;->k(IZ)Landroid/support/v7/app/e$f;
    ...
    .line 2657
    iget-object p2, v0, Landroid/support/v7/app/e$f;->og:Landroid/support/v7/view/menu/h;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/e;->kx()Z
    ...
    .line 2607
    invoke-virtual {p0, p1}, Landroid/support/v7/app/e$c;->a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
