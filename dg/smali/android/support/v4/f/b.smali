...
# static fields
.field static final JR:Landroid/support/v4/h/g;
...
.field static final Jd:Ljava/lang/Object;

.field private static final LW:Landroid/support/v4/f/c;

.field static final LX:Landroid/support/v4/h/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private static final LY:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/f/b;->JR:Landroid/support/v4/h/g;
    ...
    sput-object v0, Landroid/support/v4/f/b;->LW:Landroid/support/v4/f/c;
    ...
    sput-object v0, Landroid/support/v4/f/b;->Jd:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/f/b;->LX:Landroid/support/v4/h/l;
    ...
    sput-object v0, Landroid/support/v4/f/b;->LY:Ljava/util/Comparator;
...
.method public static a(Landroid/content/pm/PackageManager;Landroid/support/v4/f/a;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 736
    invoke-virtual {p1}, Landroid/support/v4/f/a;->getProviderAuthority()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Landroid/support/v4/f/a;->getProviderPackage()Ljava/lang/String;
    ...
    .line 755
    sget-object v0, Landroid/support/v4/f/b;->LY:Ljava/util/Comparator;
    ...
    .line 761
    invoke-static {p0, p2}, Landroid/support/v4/f/b;->b(Ljava/util/List;Ljava/util/List;)Z
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/support/v4/a/a/f$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/f/a;->ie()Ljava/lang/String;
    ...
    .line 245
    invoke-static {p0, p1, p6}, Landroid/support/v4/f/b;->a(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/support/v4/f/b$c;
    ...
    .line 247
    iget p1, p0, Landroid/support/v4/f/b$c;->Mi:I

    if-nez p1, :cond_2

    .line 248
    iget-object p1, p0, Landroid/support/v4/f/b$c;->Mh:Landroid/graphics/Typeface;
    ...
    :cond_3
    :goto_0
    iget-object p0, p0, Landroid/support/v4/f/b$c;->Mh:Landroid/graphics/Typeface;
    ...
    .line 269
    :try_start_0
    sget-object p1, Landroid/support/v4/f/b;->LW:Landroid/support/v4/f/c;
    ...
    invoke-direct {p1, p2, p3}, Landroid/support/v4/f/b$2;-><init>(Landroid/support/v4/a/a/f$a;Landroid/os/Handler;)V

    .line 289
    :goto_1
    sget-object p2, Landroid/support/v4/f/b;->Jd:Ljava/lang/Object;

    monitor-enter p2

    .line 290
    :try_start_1
    sget-object p3, Landroid/support/v4/f/b;->LX:Landroid/support/v4/h/l;

    invoke-virtual {p3, v0}, Landroid/support/v4/h/l;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p3, v0}, Landroid/support/v4/h/l;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 301
    sget-object p1, Landroid/support/v4/f/b;->LX:Landroid/support/v4/h/l;

    invoke-virtual {p1, v0, p3}, Landroid/support/v4/h/l;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static a(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/support/v4/f/b$c;
    .locals 3
    ...
    .line 190
    invoke-virtual {p1}, Landroid/support/v4/f/b$a;->getStatusCode()I
    ...
    .line 192
    invoke-virtual {p1}, Landroid/support/v4/f/b$a;->ig()[Landroid/support/v4/f/b$b;

    move-result-object p1

    .line 191
    invoke-static {p0, v0, p1, p2}, Landroid/support/v4/graphics/c;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
...
.method private static a(Landroid/support/v4/f/a;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    .line 769
    invoke-virtual {p0}, Landroid/support/v4/f/a;->getCertificates()Ljava/util/List;
    ...
    .line 772
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/f/a;->id()I
...
.method public static a(Landroid/content/Context;[Landroid/support/v4/f/b$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    .line 684
    invoke-virtual {v3}, Landroid/support/v4/f/b$b;->getResultCode()I
    ...
    .line 688
    :cond_0
    invoke-virtual {v3}, Landroid/support/v4/f/b$b;->getUri()Landroid/net/Uri;
...
.method static a(Landroid/content/Context;Landroid/support/v4/f/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/f/b$b;
    ...
    .line 831
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/f/a;->getQuery()Ljava/lang/String;
