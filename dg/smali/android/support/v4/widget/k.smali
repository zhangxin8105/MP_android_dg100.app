...
.method public static a(Ljava/lang/Object;Landroid/support/v4/widget/k$b;Landroid/support/v4/widget/k$a;Ljava/lang/Object;IZZ)Ljava/lang/Object;
    .locals 4
    ...
    .line 40
    invoke-interface {p1, p0}, Landroid/support/v4/widget/k$b;->av(Ljava/lang/Object;)I
    ...
    .line 43
    invoke-interface {p1, p0, v2}, Landroid/support/v4/widget/k$b;->get(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    .line 46
    :cond_0
    new-instance p0, Landroid/support/v4/widget/k$c;

    invoke-direct {p0, p5, p2}, Landroid/support/v4/widget/k$c;-><init>(ZLandroid/support/v4/widget/k$a;)V
    ...
    .line 51
    :pswitch_0
    invoke-static {p3, v1, p6}, Landroid/support/v4/widget/k;->a(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
    ...
    .line 53
    :pswitch_1
    invoke-static {p3, v1, p6}, Landroid/support/v4/widget/k;->b(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
...
.method public static a(Ljava/lang/Object;Landroid/support/v4/widget/k$b;Landroid/support/v4/widget/k$a;Ljava/lang/Object;Landroid/graphics/Rect;I)Ljava/lang/Object;
    ...
    .line 176
    :cond_4
    invoke-interface {p2, v5, v4}, Landroid/support/v4/widget/k$a;->b(Ljava/lang/Object;Landroid/graphics/Rect;)V

    .line 177
    invoke-static {p5, p4, v4, v0}, Landroid/support/v4/widget/k;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
...
.method private static a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 203
    invoke-static {p1, p2, p0}, Landroid/support/v4/widget/k;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    .line 209
    :cond_0
    invoke-static {p1, p3, p0}, Landroid/support/v4/widget/k;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    .line 214
    :cond_1
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/widget/k;->b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 219
    :cond_2
    invoke-static {p0, p1, p3, p2}, Landroid/support/v4/widget/k;->b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 227
    invoke-static {p0, p1, p2}, Landroid/support/v4/widget/k;->g(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result p2

    .line 225
    invoke-static {v0, p2}, Landroid/support/v4/widget/k;->O(II)I

    move-result p2

    .line 229
    invoke-static {p0, p1, p3}, Landroid/support/v4/widget/k;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v0

    .line 230
    invoke-static {p0, p1, p3}, Landroid/support/v4/widget/k;->g(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result p0

    .line 228
    invoke-static {v0, p0}, Landroid/support/v4/widget/k;->O(II)I
