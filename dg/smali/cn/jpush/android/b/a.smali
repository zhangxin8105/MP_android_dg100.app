...
.method public declared-synchronized a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)Z
    ...
    invoke-direct/range {v3 .. v8}, Lcn/jpush/android/b/a;->a(JJI)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public declared-synchronized c(Landroid/content/Context;)V
    ...
    :cond_0
    invoke-static {v4}, Lcn/jpush/android/b/b;->a(Landroid/database/Cursor;)Lcn/jpush/android/b/c;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lcn/jpush/android/b/c;->a()J

    move-result-wide v6

    invoke-virtual {v1}, Lcn/jpush/android/b/c;->f()J
