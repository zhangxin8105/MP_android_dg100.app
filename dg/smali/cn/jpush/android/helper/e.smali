...
.method private a(Landroid/content/Context;)Z
    ...
    iput-object v0, p0, Lcn/jpush/android/helper/e;->b:Landroid/content/Context;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lcn/jpush/android/helper/e;->b:Landroid/content/Context;
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/cache/Sp;->set(Landroid/content/Context;[Lcn/jpush/android/cache/Key;)V
    ...
    invoke-static {v1}, Lcn/jpush/android/e/b;->a(Landroid/content/Context;)V
    ...
    invoke-static {v1, v4}, Lcn/jpush/android/cache/a;->a(Landroid/content/Context;Z)V
    ...
    invoke-virtual {p1, p2, v4, v5}, Landroid/os/Bundle;->getLong(Ljava/lang/String;J)J
    ...
    invoke-static {v1}, Lcn/jpush/android/a/d;->a(Landroid/content/Context;)Lcn/jpush/android/a/d;

    move-result-object p3

    invoke-virtual {p3, p1, p2}, Lcn/jpush/android/a/d;->a(J)V
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/helper/e;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2, v1, p1}, Lcn/jpush/android/helper/h;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/helper/e;->c(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/helper/e;->b(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/a/d;->a(I)V
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/a/d;->a(Ljava/lang/String;)V
    ...
    instance-of p1, p3, Lcn/jpush/android/f/c;

    if-eqz p1, :cond_20

    check-cast p3, Lcn/jpush/android/f/c;

    invoke-static {v1, p3}, Lcn/jpush/android/helper/e;->a(Landroid/content/Context;Lcn/jpush/android/f/c;)V
    ...
    invoke-virtual {p1, p3, v4, v5}, Landroid/os/Bundle;->getLong(Ljava/lang/String;J)J

    move-result-wide v2

    invoke-static {v1, p2, v2, v3}, Lcn/jpush/android/helper/e;->a(Landroid/content/Context;IJ)V
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/g/a;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v1}, Lcn/jpush/android/b/a;->a(Landroid/content/Context;)Lcn/jpush/android/b/a;

    move-result-object p2

    invoke-virtual {p2, v1, p1}, Lcn/jpush/android/b/a;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)Z
    ...
    invoke-virtual {p3, v1, p1, p2}, Lcn/jpush/android/b/a;->a(Landroid/content/Context;J)Z
    ...
    invoke-virtual {p1, v1}, Lcn/jpush/android/b/a;->b(Landroid/content/Context;)V
    ...
    invoke-static {v1}, Lcn/jpush/android/helper/JCoreHelper;->getAppKey(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p3

    const-wide/16 v2, 0x0

    invoke-static {p1, p2, p3, v2, v3}, Lcn/jpush/android/c/d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Lcn/jpush/android/c/d;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcn/jpush/android/c/d;->a(Landroid/content/Context;)V

    invoke-static {v1, p1}, Lcn/jpush/android/e/b;->a(Landroid/content/Context;Lcn/jpush/android/c/d;)V
    ...
    invoke-static {p3, v2}, Lcn/jpush/android/helper/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v1, p1}, Lcn/jpush/android/h/a;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static/range {v1 .. v8}, Lcn/jpush/android/c/b;->a(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;JB)V
    ...
    sget p2, Lcn/jpush/android/a;->b:I
    ...
    invoke-virtual {p2}, Lcn/jpush/android/a/d;->a()V

    :cond_1f
    xor-int/2addr p1, v3

    sput p1, Lcn/jpush/android/a;->b:I
