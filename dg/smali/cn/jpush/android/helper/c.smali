...
.method public static a(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;Ljava/lang/String;)V
    ...
    invoke-static {p2, v1}, Lcn/jpush/android/helper/Logger;->dd(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v2, p1, Lcn/jpush/android/api/NotificationMessage;->notificationId:I

    invoke-virtual {p2, v1, v2}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "cn.jpush.android.ALERT"

    iget-object v2, p1, Lcn/jpush/android/api/NotificationMessage;->notificationContent:Ljava/lang/String;
    ...
    iget v3, p1, Lcn/jpush/android/api/NotificationMessage;->notificationAlertType:I
    ...
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationTitle:Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationExtras:Ljava/lang/String;
    ...
    :cond_2
    iget v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationStyle:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_3

    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationBigText:Ljava/lang/String;
    ...
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationInbox:Ljava/lang/String;
    ...
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationBigPicPath:Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationPriority:I
    ...
    iget v3, p1, Lcn/jpush/android/api/NotificationMessage;->notificationPriority:I
    ...
    :cond_6
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationCategory:Ljava/lang/String;
    ...
    :cond_7
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationSmallIcon:Ljava/lang/String;
    ...
    :cond_8
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->notificationLargeIcon:Ljava/lang/String;
    ...
    :cond_9
    iget-object v1, p1, Lcn/jpush/android/api/NotificationMessage;->developerArg0:Ljava/lang/String;
    ...
    invoke-static {p0, v0, p1}, Lcn/jpush/android/i/a;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
