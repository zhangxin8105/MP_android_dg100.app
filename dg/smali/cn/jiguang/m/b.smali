...
.method constructor <init>(Ljava/lang/String;I)V
    ...
    iput p2, p0, Lcn/jiguang/m/b;->c:I
    ...
    iput-object p1, p0, Lcn/jiguang/m/b;->a:Landroid/os/HandlerThread;

    iget-object p1, p0, Lcn/jiguang/m/b;->a:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object p2, p0, Lcn/jiguang/m/b;->a:Landroid/os/HandlerThread;

    invoke-virtual {p2}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p2

    new-instance v0, Lcn/jiguang/m/c;

    invoke-direct {v0, p0}, Lcn/jiguang/m/c;-><init>(Lcn/jiguang/m/b;)V

    invoke-direct {p1, p2, v0}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object p1, p0, Lcn/jiguang/m/b;->b:Landroid/os/Handler;
...
.method final a([BII)V
    ...
    invoke-static {p2}, Lcn/jiguang/m/a;->a([B)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lcn/jiguang/m/b;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcn/jiguang/m/b;->b:Landroid/os/Handler;
    ...
    iget v7, p0, Lcn/jiguang/m/b;->c:I
    ...
    invoke-static {v5, p3}, Lcn/jiguang/s/d;->a([Ljava/lang/String;I)Ljava/util/List;
