.class public final Lcn/jiguang/r/f;
...
.method public static a(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-static {}, Lcn/jiguang/r/f;->a()Z

    move-result v0

    if-eqz v0, :cond_2

    sput v1, Lcn/jiguang/r/f;->a:I

    invoke-static {p0}, Lcn/jiguang/r/f;->b(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-static {p0}, Lcn/jiguang/r/f;->c(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_4

    sput v2, Lcn/jiguang/r/f;->a:I

    invoke-static {p0}, Lcn/jiguang/r/f;->d(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    :cond_5
    invoke-static {p0}, Lcn/jiguang/r/f;->e(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcn/jiguang/r/f;->f(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    :cond_7
    invoke-static {p0}, Lcn/jiguang/r/f;->g(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcn/jiguang/r/f;->h(Landroid/content/Context;)Ljava/util/ArrayList;
...
.method private static b(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lcn/jiguang/r/f;->a(Landroid/telephony/TelephonyManager;)I
    ...
    invoke-static {v6}, Lcn/jiguang/r/f;->a(I)I

    move-result v8

    new-instance v9, Lcn/jiguang/q/b;

    invoke-direct {v9}, Lcn/jiguang/q/b;-><init>()V
    :try_end_1
    ...
    invoke-static {v10}, Lcn/jiguang/r/c;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    iput-object v10, v9, Lcn/jiguang/q/b;->a:Ljava/lang/String;
    ...
    iput-object v10, v9, Lcn/jiguang/q/b;->c:Ljava/lang/String;
    ...
    iput-object v8, v9, Lcn/jiguang/q/b;->b:Ljava/lang/String;
    :try_end_2
...
.method private static c(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcn/jiguang/r/f;->b(Landroid/telephony/TelephonyManager;)Ljava/util/ArrayList;
...
.method private static d(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    new-instance v8, Lcn/jiguang/q/b;

    invoke-direct {v8}, Lcn/jiguang/q/b;-><init>()V
    :try_end_0
    ...
    iput-object v10, v8, Lcn/jiguang/q/b;->b:Ljava/lang/String;
    ...
    iput-object v10, v8, Lcn/jiguang/q/b;->a:Ljava/lang/String;
    ...
    iput-object v9, v8, Lcn/jiguang/q/b;->c:Ljava/lang/String;
    :try_end_1
...
.method private static f(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcn/jiguang/r/c;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v4, Lcn/jiguang/q/b;->a:Ljava/lang/String;
    ...
    iput-object p0, v4, Lcn/jiguang/q/b;->b:Ljava/lang/String;
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_1
...
.method private static h(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    new-instance v2, Lcn/jiguang/q/b;

    invoke-direct {v2}, Lcn/jiguang/q/b;-><init>()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_2
    ...
    iput-object v3, v2, Lcn/jiguang/q/b;->b:Ljava/lang/String;

    invoke-virtual {p0}, Landroid/telephony/TelephonyManager;->getDeviceId()Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Lcn/jiguang/q/b;->a:Ljava/lang/String;

    invoke-virtual {p0}, Landroid/telephony/TelephonyManager;->getSimSerialNumber()Ljava/lang/String;

    move-result-object p0

    iput-object p0, v2, Lcn/jiguang/q/b;->c:Ljava/lang/String;
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    ...
    new-instance p0, Lcn/jiguang/q/b;

    invoke-direct {p0}, Lcn/jiguang/q/b;-><init>()V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_2
    ...
    iput-object v2, p0, Lcn/jiguang/q/b;->b:Ljava/lang/String;

    invoke-virtual {v1}, Landroid/telephony/TelephonyManager;->getDeviceId()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcn/jiguang/q/b;->a:Ljava/lang/String;

    invoke-virtual {v1}, Landroid/telephony/TelephonyManager;->getSimSerialNumber()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcn/jiguang/q/b;->c:Ljava/lang/String;
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_1
