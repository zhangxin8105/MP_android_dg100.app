...
.method public static a(Landroid/content/Context;Lcom/alibaba/sdk/android/push/notification/c;)Landroid/app/Notification;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/y$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1}, Lcom/alibaba/sdk/android/push/notification/c;->b()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/app/y$b;->i(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/y$b;->j(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/y$b;->bk(I)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/app/y$b;->bl(I)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {p1, p0}, Landroid/support/v4/app/y$b;->b(Landroid/graphics/Bitmap;)Landroid/support/v4/app/y$b;

    invoke-virtual {v0}, Landroid/support/v4/app/y$b;->build()Landroid/app/Notification;
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/app/y$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Landroid/support/v4/app/y$b;->a(Landroid/widget/RemoteViews;)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/y$b;->bl(I)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/y$b;->bk(I)Landroid/support/v4/app/y$b;

    invoke-virtual {v1}, Landroid/support/v4/app/y$b;->build()Landroid/app/Notification;
