...
.method public final a(Landroid/content/Context;)Landroid/app/Notification;
    ...
    invoke-direct {v2, p1}, Landroid/support/v4/app/y$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0}, Lcom/alibaba/sdk/android/push/notification/a;->a()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v2, p1}, Landroid/support/v4/app/y$b;->i(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {p1, v3}, Landroid/support/v4/app/y$b;->j(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroid/support/v4/app/y$b;->bk(I)Landroid/support/v4/app/y$b;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/app/y$b;->bl(I)Landroid/support/v4/app/y$b;

    move-result-object p1

    invoke-virtual {p1, v0}, Landroid/support/v4/app/y$b;->b(Landroid/graphics/Bitmap;)Landroid/support/v4/app/y$b;

    invoke-virtual {v2}, Landroid/support/v4/app/y$b;->build()Landroid/app/Notification;
