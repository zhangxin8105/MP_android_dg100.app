...
.method private e()V
    ...
    iget-wide v4, p0, Lcom/alibaba/sdk/android/feedback/util/c;->h:J
    ...
    :cond_3
    iget-object v4, p0, Lcom/alibaba/sdk/android/feedback/util/c;->f:Lcom/alibaba/sdk/android/feedback/util/IWxCallback;

    if-eqz v4, :cond_4

    const-string v4, "ChattingRecorder"

    const-string v5, "stopRecord callback"

    invoke-static {v4, v5}, Lcom/alibaba/sdk/android/feedback/xblink/i/g;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v4, "AudioRecordingSuccess"

    invoke-static {v4, v1}, Lcom/alibaba/sdk/android/feedback/util/n;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v1, v4}, Lcom/alibaba/sdk/android/feedback/util/IWxCallback;->onSuccess([Ljava/lang/Object;)V
