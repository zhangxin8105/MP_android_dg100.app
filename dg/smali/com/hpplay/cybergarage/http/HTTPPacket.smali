...
.method protected set(Ljava/io/InputStream;Z)Z
    ...
    .line 178
    new-instance v5, Lcom/hpplay/cybergarage/http/HTTPStatus;

    invoke-direct {v5, v0}, Lcom/hpplay/cybergarage/http/HTTPStatus;-><init>(Ljava/lang/String;)V

    .line 179
    invoke-virtual {v5}, Lcom/hpplay/cybergarage/http/HTTPStatus;->getStatusCode()I
    ...
    .line 188
    new-instance v5, Lcom/hpplay/cybergarage/http/HTTPHeader;

    invoke-direct {v5, v0}, Lcom/hpplay/cybergarage/http/HTTPHeader;-><init>(Ljava/lang/String;)V

    .line 189
    invoke-virtual {v5}, Lcom/hpplay/cybergarage/http/HTTPHeader;->hasName()Z
    ...
    .line 190
    invoke-virtual {v1, v5}, Lcom/hpplay/cybergarage/http/HTTPPacket;->setHeader(Lcom/hpplay/cybergarage/http/HTTPHeader;)V
    ...
    .line 212
    invoke-virtual {v1, v0, v3}, Lcom/hpplay/cybergarage/http/HTTPPacket;->setContent(Ljava/lang/String;Z)V
    ...
    .line 246
    :try_start_3
    invoke-virtual {v4, v0, v3, v6}, Ljava/io/BufferedInputStream;->read([BII)I
    ...
    .line 249
    :cond_c
    invoke-virtual {v12, v0, v3, v6}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    :try_end_3
    ...
    :try_start_4
    const-string v6, "Cyber-HTTPPacket"

    .line 252
    invoke-static {v6, v2, v0}, Lcom/hpplay/cybergarage/util/UPnPLog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v6, v7, v3, v0}, Ljava/lang/String;-><init>([BII)V
    :try_end_5
    ...
    invoke-virtual {v1, v0, v3}, Lcom/hpplay/cybergarage/http/HTTPPacket;->setContent([BZ)V
    :try_end_7
    ...
    const-string v4, "Cyber-HTTPPacket"

    .line 280
    invoke-static {v4, v2, v0}, Lcom/hpplay/cybergarage/util/UPnPLog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
