...
.method protected a(Lcom/meizu/cloud/pushsdk/handler/a/b/g;)V
    ...
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/handler/a/b/g;->d()Lcom/meizu/cloud/pushsdk/handler/a/b/b;
...
.method protected a(Lcom/meizu/cloud/pushsdk/handler/a/b/g;Lcom/meizu/cloud/pushsdk/notification/c;)V
    ...
    invoke-virtual {v0}, Lcom/meizu/cloud/pushsdk/handler/a/b/b;->b()Lcom/meizu/cloud/pushsdk/handler/a/b/f;

    move-result-object v0

    invoke-virtual {v0}, Lcom/meizu/cloud/pushsdk/handler/a/b/f;->a()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/meizu/cloud/pushsdk/handler/a/b/b;->b()Lcom/meizu/cloud/pushsdk/handler/a/b/f;

    move-result-object v1

    invoke-virtual {v1}, Lcom/meizu/cloud/pushsdk/handler/a/b/f;->d()Ljava/lang/String;
    ...
    const-string p2, "/Android/data/pushSdktmp/"
    ...
    invoke-direct {v0, p2}, Lcom/meizu/cloud/pushsdk/handler/a/a/b;-><init>(Ljava/lang/String;)V

    const/4 v1, 0x0

    :try_start_0
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/handler/a/b/g;->c()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/meizu/cloud/pushsdk/handler/a/a/b;->a(Ljava/util/List;)Z
    ...
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/handler/a/b/g;->a()I
    ...
    const-string p2, "the upload file exceeds the max size"

    goto :goto_1

    :cond_0
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/handler/a/b/g;->b()Z
    ...
    const-string p2, "current network not allowed upload log file"
    ...
    invoke-virtual {v2}, Lcom/meizu/cloud/pushsdk/handler/a/b/f;->a()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/handler/a/b/f;->d()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, v2, p1, p2, v0}, Lcom/meizu/cloud/pushsdk/platform/a/b;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Lcom/meizu/cloud/pushsdk/b/a/c;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/b/a/c;->b()Z
    ...
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/b/a/c;->a()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/meizu/cloud/pushsdk/b/a/c;->c()Lcom/meizu/cloud/pushsdk/b/b/a;
...
.method protected bridge synthetic a(Ljava/lang/Object;Lcom/meizu/cloud/pushsdk/notification/c;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/meizu/cloud/pushsdk/handler/a/a/a;->a(Lcom/meizu/cloud/pushsdk/handler/a/b/g;Lcom/meizu/cloud/pushsdk/notification/c;)V
...
.method protected synthetic b(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/meizu/cloud/pushsdk/handler/a/a/a;->a(Lcom/meizu/cloud/pushsdk/handler/a/b/g;)V
...
.method protected synthetic c(Landroid/content/Intent;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/meizu/cloud/pushsdk/handler/a/a/a;->j(Landroid/content/Intent;)Lcom/meizu/cloud/pushsdk/handler/a/b/g;
...
.method protected j(Landroid/content/Intent;)Lcom/meizu/cloud/pushsdk/handler/a/b/g;
    ...
    new-instance v3, Lcom/meizu/cloud/pushsdk/handler/a/b/g;

    invoke-direct {v3, p1, v0, v2, v1}, Lcom/meizu/cloud/pushsdk/handler/a/b/g;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
