...
.method static synthetic a(Lcom/taobao/accs/internal/b;[BI)V
    ...
    iput p1, p2, Lcom/taobao/accs/ut/monitor/ElectionRateMonitor;->c:I
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string v6, "onStartCommand begin"
    ...
    iget-object v12, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v12}, Lcom/taobao/accs/a/a;->a(Landroid/content/Context;)Lcom/taobao/accs/a/a$a;

    move-result-object v12

    iget-object v13, v12, Lcom/taobao/accs/a/a$a;->a:Ljava/lang/String;

    const-string v14, "ElectionServiceImpl"

    const-string v15, "onstartcommand PACKAGE_REMOVED"
    ...
    invoke-static {v14, v15, v6}, Lcom/taobao/accs/utl/ALog;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v5}, Lcom/taobao/accs/a/a;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    iput v9, v12, Lcom/taobao/accs/a/a$a;->b:I

    iget-object v0, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v0, v12}, Lcom/taobao/accs/a/a;->a(Landroid/content/Context;Lcom/taobao/accs/a/a$a;)V

    iget-object v0, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    const-string v5, "host removed"

    invoke-direct {v1, v0, v5}, Lcom/taobao/accs/internal/b;->b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v5, "onstartcommand PACKAGE_REMOVED no need election"

    new-array v6, v9, [Ljava/lang/Object;

    :goto_0
    invoke-static {v0, v5, v6}, Lcom/taobao/accs/utl/ALog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    check-cast v5, Lcom/taobao/accs/common/Constants$Operate;

    const-string v6, "ElectionServiceImpl"

    const-string v12, "operate is receive"
    ...
    sget-object v6, Lcom/taobao/accs/internal/h;->a:[I

    invoke-virtual {v5}, Lcom/taobao/accs/common/Constants$Operate;->ordinal()I
    ...
    const-string v14, "com.taobao.accs.ChannelService"

    invoke-virtual {v13, v12, v14}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v14, "operate"

    sget-object v15, Lcom/taobao/accs/common/Constants$Operate;->PING_ELECTION:Lcom/taobao/accs/common/Constants$Operate;
    ...
    const-string v6, "receive host\'s ping back"
    ...
    invoke-static {v0, v6, v12}, Lcom/taobao/accs/utl/ALog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :pswitch_1
    iput-boolean v8, v1, Lcom/taobao/accs/internal/b;->d:Z

    iget-object v5, v1, Lcom/taobao/accs/internal/b;->m:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v5, v1, Lcom/taobao/accs/internal/b;->m:Ljava/util/concurrent/ScheduledFuture;

    :cond_5
    const-string v5, "sudoPack"
    ...
    const-string v12, "election result"
    ...
    const-string v12, "ele_pkg_times"

    const-wide/16 v13, 0x0

    invoke-static {v6, v12, v5, v13, v14}, Lcom/taobao/accs/utl/b;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;D)V

    iget-object v6, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v6}, Lcom/taobao/accs/a/a;->b(Landroid/content/Context;)Lcom/taobao/accs/a/a$a;
    ...
    :pswitch_2
    iget-boolean v0, v1, Lcom/taobao/accs/internal/b;->c:Z
    ...
    sget v6, Lcom/taobao/accs/internal/b;->g:I

    sub-int/2addr v6, v8

    sput v6, Lcom/taobao/accs/internal/b;->g:I

    if-eqz v5, :cond_7

    iget-object v6, v1, Lcom/taobao/accs/internal/b;->e:Ljava/util/Map;
    ...
    const-string v5, "election pkg"

    aput-object v5, v13, v3

    aput-object v0, v13, v11

    const-string v0, "electionPackCount"
    ...
    const-string v5, "not electioning, but receive report"
    ...
    sget-object v14, Lcom/taobao/accs/common/Constants$Operate;->REPORT_VERSION:Lcom/taobao/accs/common/Constants$Operate;
    ...
    iget-object v14, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;
    ...
    invoke-virtual {v12, v0, v13}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v13, v14, v5}, Lcom/taobao/accs/a/a;->a(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    invoke-virtual {v5, v12}, Landroid/content/Context;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    invoke-static {v5, v12, v13}, Lcom/taobao/accs/utl/ALog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v5, v0}, Lcom/taobao/accs/internal/b;->b(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-static {v0}, Lcom/taobao/accs/utl/UtilityImpl;->q(Landroid/content/Context;)Z
    ...
    invoke-direct {v1, v0, v5}, Lcom/taobao/accs/internal/b;->a(Landroid/content/Context;Ljava/lang/String;)V

    iget-object v0, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v0}, Lcom/taobao/accs/utl/UtilityImpl;->r(Landroid/content/Context;)V
    ...
    const-string v12, "tryElection begin"

    new-array v13, v7, [Ljava/lang/Object;

    const-string v14, "isFirstStart"

    aput-object v14, v13, v9

    iget-object v14, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v14}, Lcom/taobao/accs/utl/UtilityImpl;->q(Landroid/content/Context;)Z
    ...
    const-string v14, "currentPack"

    aput-object v14, v13, v3

    aput-object v0, v13, v11

    const-string v14, "currentElectionPack"
    ...
    const-string v5, "host is empty, try selectAppToElection"
    ...
    invoke-virtual {v6, v5, v14}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string v6, "tryElection send PING_ELECTION"
    ...
    invoke-static {v0, v6, v14}, Lcom/taobao/accs/utl/ALog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :try_start_3
    iget-object v0, v1, Lcom/taobao/accs/internal/b;->f:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v6, Lcom/taobao/accs/internal/d;

    invoke-direct {v6, v1, v5}, Lcom/taobao/accs/internal/d;-><init>(Lcom/taobao/accs/internal/b;Ljava/lang/String;)V

    sget-object v5, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    :goto_2
    invoke-virtual {v0, v6, v12, v13, v5}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_1
    ...
    const-string v14, "tryElection startService error"

    new-array v15, v11, [Ljava/lang/Object;

    const-string v17, "currentElectionPack"
    ...
    invoke-static {v6, v14, v15}, Lcom/taobao/accs/utl/ALog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    new-instance v14, Lcom/taobao/accs/internal/d;

    invoke-direct {v14, v1, v5}, Lcom/taobao/accs/internal/d;-><init>(Lcom/taobao/accs/internal/b;Ljava/lang/String;)V

    sget-object v5, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v6, v14, v12, v13, v5}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    const-string v5, "curr is host, no need election"
    ...
    const-string v6, "tryElection error"

    new-array v12, v9, [Ljava/lang/Object;

    invoke-static {v5, v6, v0, v12}, Lcom/taobao/accs/utl/ALog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    :try_end_6
    ...
    const-string v7, "try to saveAppKey"

    const/16 v10, 0xa

    new-array v10, v10, [Ljava/lang/Object;

    const-string v17, "configTag"
    ...
    invoke-static {v15, v7, v10}, Lcom/taobao/accs/utl/ALog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v14}, Lcom/taobao/accs/utl/l;->a(Landroid/content/Context;I)V

    iget-object v0, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    const/4 v7, -0x1

    invoke-static {v0, v13, v9, v7}, Lcom/taobao/accs/internal/b;->a(Landroid/content/Context;Ljava/lang/String;ZI)Lcom/taobao/accs/net/b;

    move-result-object v0

    if-eqz v0, :cond_10

    iput-object v6, v0, Lcom/taobao/accs/net/b;->a:Ljava/lang/String;
    ...
    const-string v6, "start action, no connection"
    ...
    invoke-static {v0, v6, v7}, Lcom/taobao/accs/utl/ALog;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :goto_6
    iget-object v0, v1, Lcom/taobao/accs/internal/b;->b:Landroid/content/Context;

    invoke-static {v0, v5}, Lcom/taobao/accs/utl/UtilityImpl;->d(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_7
    ...
    const-string v2, "not electioning and not host, stop"
    ...
    const-string v5, "deliver to channelservice"

    new-array v3, v3, [Ljava/lang/Object;

    const-string v6, "host pkg"
