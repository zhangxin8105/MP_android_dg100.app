.class public Lcom/huawei/android/hms/agent/pay/HMSPayAgentActivity;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-interface {p1, p3}, Lcom/huawei/hms/support/api/pay/HuaweiPayApi;->getPayResultInfoFromIntent(Landroid/content/Intent;)Lcom/huawei/hms/support/api/pay/PayResultInfo;
    ...
    .line 52
    sget-object p2, Lcom/huawei/android/hms/agent/pay/a;->btq:Lcom/huawei/android/hms/agent/pay/a;

    invoke-virtual {p1}, Lcom/huawei/hms/support/api/pay/PayResultInfo;->getReturnCode()I

    move-result p3

    invoke-virtual {p2, p3, p1}, Lcom/huawei/android/hms/agent/pay/a;->a(ILcom/huawei/hms/support/api/pay/PayResultInfo;)V

    goto :goto_0

    .line 54
    :cond_0
    sget-object p1, Lcom/huawei/android/hms/agent/pay/a;->btq:Lcom/huawei/android/hms/agent/pay/a;

    const/16 p2, -0x3ea

    invoke-virtual {p1, p2, v0}, Lcom/huawei/android/hms/agent/pay/a;->a(ILcom/huawei/hms/support/api/pay/PayResultInfo;)V
    ...
    .line 60
    :goto_0
    invoke-virtual {p0}, Lcom/huawei/android/hms/agent/pay/HMSPayAgentActivity;->finish()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1}, Lcom/huawei/android/hms/agent/pay/a;->EF()Lcom/huawei/hms/support/api/client/Status;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/huawei/android/hms/agent/pay/a;->a(ILcom/huawei/hms/support/api/pay/PayResultInfo;)V
    ...
    :cond_0
    const-string p1, "statusForPay is null"
